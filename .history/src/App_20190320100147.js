...
// 更细数组内容
  updateArray(index) {
    console.log(index);
    this.setState(state => {
      console.log("havedones1: " + state.havedones);
      console.log("this is " + state.all[index]);
      let havedones = state.havedones.push(state.all[index]);
      console.log("havedones" + havedones);
      return{
        havedones: havedones
      }
    })
