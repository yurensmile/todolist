        ...
        {this.props.laters.map((item, index)=>{
          return (
            <div onClick={
              ...
              <input className="toggle" type="checkbox"  key={index}/>
              <span class="later circle" key={index+1}></span>
              <li class="left" key={index+2}>{item}
              <button class="delete"  key={index+3}>delete</button>
              </li>
            </div>
          )
        })}
