...
// 如果havedone中的某个被点击，则在havedone中删除，并添加到later中
  ...
  render() {
    return (
      <div className="App">
        <input type="text" hint="input what you will do" name="todo" value={this.state.inputValue} onChange={this.updateInputValue.bind(this)}/>
        <button onClick={this.handleOnClick.bind(this)}>Add</button><br/>
        <span>{this.state.laters.length}未做&nbsp;&nbsp; </span>
        <span>{this.state.havedones.length}已做</span>
